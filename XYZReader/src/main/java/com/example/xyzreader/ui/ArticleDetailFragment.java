...
public class ArticleDetailFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void bindViews() {
        ...
        mNestedScrollView = mRootView.findViewById(R.id.nested_scroll_view);

        mArticleTitle = mRootView.findViewById(R.id.article_title);
        mArticleInfo = mRootView.findViewById(R.id.article_info);
        mArticleBody = mRootView.findViewById(R.id.article_body);
    }
